...
include("RDE_VisualisationFunctions.jl")
...
r19 = CSV.read("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
or19 = CSV.read("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/other_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
ar19 = CSV.read("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/aug_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
tr19 = CSV.read("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/tuning_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
ut19 = CSV.read("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/update_tracker_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
...
param_names = ["β_c", "γ", "F", "ϵ", "ρ", "ρ_E"]

param_names_inf = ["β_c", "γ", "F", "ϵ"]
...
chain_full = Chains(Array(r19[:, 1:6]), param_names)
chainplot1 = plot(chain_full)
...
chain_mix1 = Chains(Array(r19)[1:5000, 1:6], param_names)
chainplot2 = plot(chain_mix1)
...
chain_mix2 = Chains(Array(r19)[5001:end, 1:6], param_names)
chainplot3 = plot(chain_mix2)
...
corr_plot1 = corrplot(Array(r19[5001:end, 1:3]), label = ["β_c", "γ", "F"], fc = :thermal, ticks = true, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
corr_plot2 = corrplot(Array(r19[5001:end, [1,2,4]]), label = ["β_c", "F", "ϵ"], fc = :thermal, ticks = true, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
corr_plot3 = corrplot(Array(r19[5001:end, [1,2,3,4]]), label = ["β_c", "γ", "F", "ϵ"], fc = :thermal, ticks = false, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
corr_plot4 = corrplot(Array(r19[5001:end, 5:6]), label = ["ρ", "ρ_E"], fc = :thermal, ticks = true, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
multi_kde_plot1 = @df r19[5001:end, 1:3] cornerplot([:β_c, :γ, :F], label = ["β_c", "γ", "F"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
multi_kde_plot2 = @df r19[5001:end, [1,2,4]] cornerplot([:β_c, :γ, :ϵ], label = ["β_c", "F", "ϵ"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
multi_kde_plot3 = @df r19[5001:end, [1,2,3,4]] cornerplot([:β_c, :γ, :F, :ϵ], label = ["β_c", "γ", "F", "ϵ"], ticks = false, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
multi_kde_plot4 = @df r19[5001:end, 5:6] cornerplot([:ρ, :ρ_E], label = ["ρ", "ρ_E"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)
...
r19 = CSV.read("Inference/Results_19_rhos_fixed/res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
or19 = CSV.read("Inference/Results_19_rhos_fixed/other_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
ar19 = CSV.read("Inference/Results_19_rhos_fixed/aug_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
tr19 = CSV.read("Inference/Results_19_rhos_fixed/tuning_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
ut19 = CSV.read("Inference/Results_19_rhos_fixed/update_tracker_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", DataFrame)
...
chain_full = Chains(Array(r19[5001:end, 1:4]), param_names_inf)
chainplot1 = plot(chain_full)

savefig(chainplot1, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_chain_full.pdf"))

chain_mix1 = Chains(Array(r19)[1:5000, 1:6], param_names)
chainplot2 = plot(chain_mix1)

savefig(chainplot2, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_chain_tuning.pdf"))

chain_mix2 = Chains(Array(r19)[5001:end, 1:6], param_names)
chainplot3 = plot(chain_mix2)

savefig(chainplot3, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_chain_post_tuning.pdf"))
...
savefig(post_plot1, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_tuning_inf.pdf"))

post_plot2 = plot_inf_posterior_compare(or19, 5001, number_of_samples, string("Infection Parameters Posterior Comparison Mixture 2"), :bottomright, 0.5)

savefig(post_plot2, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_post_tuning_inf.pdf"))

post_plot3 = plot_inf_posterior_compare(or19, 1, number_of_samples, string("Infection Parameters Posterior Comparison Full"), :bottomright, 0.5)

savefig(post_plot3, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_full_inf.pdf"))


post_plot4 = plot_det_posterior_compare(or19, 1, 5000, string("Detection Parameters Posterior Comparison Mixture 1"), :bottomright, 0.5)

savefig(post_plot4, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_tuning_det.pdf"))

post_plot5 = plot_det_posterior_compare(or19, 5001, number_of_samples, string("Detection Parameters Posterior Comparison Mixture 2"), :bottomright, 0.5)

savefig(post_plot5, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_post_tuning_det.pdf"))

post_plot6 = plot_det_posterior_compare(or19, 1, number_of_samples, string("Detection Parameters Posterior Comparison Full"), :bottomright, 0.5)

savefig(post_plot6, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_diagnostic_likelihoods_full_det.pdf"))
...
savefig(acc_plot1, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_cumulative_acceptance_rate_inf.pdf"))


acc_plot2 = plot_acc_rates_against_λ_and_m_inf_scaled(or19, tr19, 1, 5000, number_of_samples, string("Infection Parameters Acceptance Rates and Tuning Parameters Mixture 1"), :topright, false)

savefig(acc_plot2, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_tuning_inf.pdf"))

acc_plot3 = plot_acc_rates_against_λ_and_m_inf_scaled(or19, tr19, 5001, number_of_samples, number_of_samples, string("Infection Parameters Acceptance Rates and Tuning Parameters Mixture 2"), :topright, false)

savefig(acc_plot3, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_post_tuning_inf.pdf"))

acc_plot4 = plot_acc_rates_against_λ_and_m_inf_scaled(or19, tr19, 1, number_of_samples, number_of_samples, string("Infection Parameters Acceptance Rates and Tuning Parameters Full"), :topright, true)

savefig(acc_plot4, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_full_inf.pdf"))
...
savefig(acc_plot5, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_cumulative_acceptance_rate_det.pdf"))


acc_plot6 = plot_acc_rates_against_λ_and_m_det_scaled(or19, tr19, 1, 5000, number_of_samples, string("Detection Parameters Acceptance Rates and Tuning Parameters Mixture 1"), :topright, false)

savefig(acc_plot6, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_tuning_det.pdf"))

acc_plot7 = plot_acc_rates_against_λ_and_m_det_scaled(or19, tr19, 5001, number_of_samples, number_of_samples, string("Detection Parameters Acceptance Rates and Tuning Parameters Mixture 2"), :topright, false)

savefig(acc_plot7, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_post_tuning_det.pdf"))

acc_plot8 = plot_acc_rates_against_λ_and_m_det_scaled(or19, tr19, 1, number_of_samples, number_of_samples, string("Detection Parameters Acceptance Rates and Tuning Parameters Full"), :topright, true)

savefig(acc_plot8, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_batch_acceptance_rate_full_det.pdf"))
...
savefig(corr_plot1, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_Corr_bbg.pdf"))

corr_plot2 = corrplot(Array(r19[5001:end, [1,2,4]]), label = ["β_c", "F", "ϵ"], fc = :thermal, ticks = true, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(corr_plot2, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_Corr_bbf.pdf"))

corr_plot3 = corrplot(Array(r19[5001:end, [1,2,3,4]]), label = ["β_c", "γ", "F", "ϵ"], fc = :thermal, ticks = false, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(corr_plot3, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_Corr_inf.pdf"))


corr_plot4 = corrplot(Array(r19[5001:end, 5:6]), label = ["ρ", "ρ_E"], fc = :thermal, ticks = true, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(corr_plot4, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_Corr_det.pdf"))



multi_kde_plot1 = @df r19[5001:end, 1:3] cornerplot([:β_c, :γ, :F], label = ["β_c", "γ", "F"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(multi_kde_plot1, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_KDE_bbg.pdf"))

multi_kde_plot2 = @df r19[5001:end, [1,2,4]] cornerplot([:β_c, :γ, :ϵ], label = ["β_c", "F", "ϵ"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(multi_kde_plot2, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_KDE_bbf.pdf"))

multi_kde_plot3 = @df r19[5001:end, [1,2,3,4]] cornerplot([:β_c, :γ, :F, :ϵ], label = ["β_c", "γ", "F", "ϵ"], ticks = false, size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(multi_kde_plot3, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_KDE_inf.pdf"))


multi_kde_plot4 = @df r19[5001:end, 5:6] cornerplot([:ρ, :ρ_E], label = ["ρ", "ρ_E"], size = (3000, 1800), bottom_margin = 20mm, left_margin = 25mm, right_margin = 55mm, dpi = 300)

savefig(multi_kde_plot4, string("Visualisation/Results_19_rhos_fixed/", "allpars", "_Multi_KDE_det.pdf"))
