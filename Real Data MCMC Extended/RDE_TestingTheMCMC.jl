...
include("RDE_Likelihood.jl")
include("RDE_DataUpdaters.jl")
include("RDE_Proposals.jl")
include("RDE_Posterior.jl")
include("RDE_MCMCfuncs.jl")
...
dict_of_movements = load("Data/Set Real Subset/dict_of_movements_oi_real.jld2")["dict"]

ids_to_pos_dict = load("Data/Set Real Subset/ids_to_pos_dict.jld2")["dict"]
...
epi_params_true = [β_c_tr, γ_tr, F_tr, ϵ_tr, ρ_tr, ρ_E_tr]
...
epi_params_dists = [d_β_c, d_γ, d_F, d_ϵ, d_ρ, d_ρ_E]
...
CSV.write("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/init_conditions_aug_res_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", icr19, header = true)
CSV.write("Inference/Results_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves]/init_conditions_tracker_19_[Inf][Det][mSE][mEI][arSE][arEI][arDet][arDeath][arPEnv][arMoves].csv", ictr19, header = true)
save("Data/Results_19/DATA_res_and_track_post_run.jld2", "array", DRT_pr_19)
save("Data/Results_19/DATA_pers_and_parish_post_run.jld2", "array", DPP_pr_19)
